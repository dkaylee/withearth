...
<style>
    .wrap {position: absolute;left: -140px;bottom: 40px;width: 288px;height: 132px;margin-left: -144px;text-align: left;overflow: hidden;font-size: 12px;font-family: 'Malgun Gothic', dotum, '돋움', sans-serif;line-height: 1.5;}
		   	 ...
		   	 for (i = 0; i < positions.length; i++) {
		   			...
		   			//var content = positions[i].cafe_name;
		   			 var content = '<div class="wrap">' + 
			   	            ...
			   	            '        <div class="body">' + 
			   	            '            <div class="img">' +
			   	            '                <img alt="point2" src="<c:url value="/img/cafe.png"/>"  width="73" height="70">' +
			   	            '           </div>' + 
			   	         
			   	            '            <div class="desc">' + 
			   	            '                <div class="ellipsis">'+
			   	            '             <p class="adrr">'+
			   	                                   positions[i].location+'</p>' +
			   	            '                   </div>' + 
