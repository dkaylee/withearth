...
<body class="subpage">
	...
	<section id="main" class="wrapper">
		...
		<div id="modal_btn">
			...
			<button id="open" onclick="location='tumblist'">텀블러 이용내역</button>
		</div>
...
<script>
		 ...
		 */
				...
				$.ajsx({
					...
					url: "http://localhost:8080/tumbler/qr',
					type:'GET',
					success:function(data){
						...
						$.each(data, function(index, item){
							...
							var  html += '  <c:forEach items="${listView}" var="tumbler" varStatus="status">';
								 html += '  <tr>';
									 html += '  <td>${tumbler.tum_idx}</td>';
										 html += '  <td>${tumbler.tum_date}</td>';
											 html += '  <td>${tumbler.cafe_name}</td>';
												 html += '  <td>${tumbler.tum_point}p</td>';
													 html += '  </tr>';
														 html += '  </c:forEach>';
