...
<section id="one" class="wrapper">
	<div class="inner">
		<div class="flex flex-3">
			...
			<article>
				<header>
				<img src="<c:url value="/img/main/tumbler.png"/>" width="200px;">
					<h3>
						텀블러 사용 인증하기<br />
					</h3>
				</header>				
			...
			<article>
				<header>
				<img src="<c:url value="/img/main/walk.png"/>" width="200px;"><br>
					<h3>
						도보 인증 서비스<br />
					</h3>
				</header>
			...
			<article>
				<header>
				<img src="<c:url value="/img/main/heart.png"/>" width="200px;">
					<h3>
						기부하기<br />
					</h3>
				</header>
	...
	<div class="inner">
		...
		<div class="flex flex-2">
			<article>
				...
				<header>
				<img src="<c:url value="/img/main/recycle.png"/>" width="200px;">
					<h3>분리배출 한 눈에 보기</h3>
				</header>
