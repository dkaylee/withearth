			...
			<header id="header">
				<div class="inner">
					...
					<nav id="nav">
						...
						<a href="<c:url value="/tumbler/tumlist1?idx=${loginInfo.idx}"/>">텀블러사용 인증</a>
						...
						<a href="<c:url value="/matzip/matlist?p=1"/>">맛집</a>						
						<a href="<c:url value="/board/listPage?num=1"/>">커뮤니티</a>
					</nav>
