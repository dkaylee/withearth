...
<body>
	...
	<div class="row mb-md-5">
		<div
			...
			<a class="list-group-item list-group-item-action active"
				id="startWalking" data-toggle="list" href="#" role="tab">바로 시작</a> <a
				class="list-group-item list-group-item-action" id="WalkingGuide"
				data-toggle="list" id="WalkingGuide" href="#" role="tab">라이딩 가이드</a>
	...
	<div class="container">
		...
		<h4 class="font-weight-bold pt-5 mb-4">
			<i class="fas fa-biking"> 라이딩 시작하기</i>
		</h4>
		...
		<div style="margin-bottom: 20px;">
			<div>
				< <i class="fas fa-flag-checkered"> 도착지점</i> <input type="text"
					id="endPoint" style="width: 180px; margin-left: 10px"
					placeholder="예)명동역">
				<button type="button" id="searchEndPoint" style="margin-top: -3px"
					class="btn btn-primary btn-sm" onclick="searchPOIEnd()">
					<i class="fas fa-search-location"> 검색</i>
				</button>
			</div>
		</div>
				...
				<div class="modal-content">
					...
					<form>
						<div class="modal-body">
							<div class="form-group">
								<label for="myCourse_name">코스 이름</label> <input
									id="myCourse_name" name="p_name" type="text"
									placeholder="코스 이름" class="form-control" required="required">
							</div>

							<div class="form-group">
								<label for="myCourse_descript">코스 설명</label> <input
									id="myCourse_descript" name="p_content" type="text"
									placeholder="코스 설명" class="form-control" required="required">
							</div>
						</div>
					</form>
					<div class="modal-footer">
						...
						<button type="button" class="btn btn-primary"
							onclick="regMyCourse()">코스 등록</button>
					</div>
				</div>
			</div>
		</div>
	  ...
	  //시작 버튼 눌렀을 떄 일어나는 함수
	    ...
	    var map, marker, markerStartPointLayer, markerEndPointLayer, markersLayer, routeLayer;
      ...
      //*******************************************현재 나의 위치를 찾고, 그 위치를 startPoint로 등록******************************************************
        function getStartPoint() {
            ...
            if ("geolocation" in navigator) {
                ...
                navigator.geolocation.getCurrentPosition(function(position) {
                    ...
                    var icon = new Tmapv2.IconHtml('<img src="http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_m_e.png" />', size, offset);
        ...
        function addMarker(options) {
             ...
             var icon = new Tmapv2.Icon("http://tmapapi.sktelecom.com/upload/tmap/marker/pin_b_s_simple.png", size, offset); //마커 아이콘입니다.
        ...
        function onCompleteTData(e) {
            ...
            function setEndPoint(lon, lat) {
               ...
               markerEndPointLayer.setMap(null);      
                ...
                var icon = new Tmapv2.IconHtml('<img src=http://tmapapi.sktelecom.com/upload/tmap/marker/pin_r_m_g.png />', size, offset); //마커 아이콘 설정
          ...
          //데이터 저장하기!!!
            function saveData() {     	        
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        r_walking_time: exTime,
                        r_walking_time: DrawLine.totDistance.toFixed(2),
