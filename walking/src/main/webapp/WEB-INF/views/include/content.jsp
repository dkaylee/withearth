...
<section id="two" class="wrapper style1 special">
	...
	<div class="flex flex-4">
						<div class="box person" >
							<div class="image round">
								<a href="<c:url value="#"/>"> <!-- 레시피 화면 링크 -->
									<img src="<c:url value="/img/test1.jpg"/>" alt="Food1" >
								</a>
							</div>
						...
						<div class="box person">
							<div class="image round">
								<a href="<c:url value="#"/>"> <!-- 레시피 화면 링크 -->
									<img src="<c:url value="/img/test2.jpg"/>" alt="Food2">
								</a>
							</div>
						...
						<div class="box person">
							<div class="image round">
								<a href="<c:url value="#"/>"> <!-- 레시피 화면 링크 -->
									<img src="<c:url value="/img/test3.jpg"/>" alt="Food3" >
								</a>
							</div>
						...
						<div class="box person">
							<div class="image round">
								<a href="<c:url value="#"/>"> <!-- 레시피 화면 링크 -->
									<img src="<c:url value="/img/test4.jpg"/>" alt="Food4" >
								</a>
							</div>
